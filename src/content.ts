...
export const proposalContent: ProposalContent = {
  ...
  companyProfile: {
    ...
    text: "Unimos atuação contábil, fiscal, trabalhista e RH com uma operação consultiva, tecnologia em evolução e atendimento pessoal. A proposta é simplificar a gestão com eficiência e inteligência tributária, garantindo segurança para crescer.",
  },
  dna: [
    {
      title: "Propósito",
